	...
	<div class="wrapper">
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="description text-center">
							<h2>Raung Diagnosis Computer</h2>
							<br>
		...
		<section class="section section-no-padding page-scroll" id="about">
			<div class="parallax filter-gradient blue" data-color="blue">
				...
				<div class="info">
					<h1>About Us</h1>
					<p>Sistem Pakar ini dibangun untuk membantu para pengguna atau teknisi computer/laptop dalam mendiagnosa kerusakan hardware maupun software.
					</p>
				</div>
			</div>
		</section>